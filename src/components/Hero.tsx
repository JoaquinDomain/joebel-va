  ...
  return (
    <section id="home" ref={ref} className="relative isolate overflow-hidden">
      ...
      >
        ...
        <div className="mt-12 grid gap-10 text-left md:grid-cols-2">
          {[
            ...
            >
              <h3 className="font-[family-name:var(--font-playfair)] text-lg">{block.title}</h3>
      ...
      <motion.div
        ...
        className="pointer-events-none absolute bottom-8 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[0.3em] opacity-60"
      >
        scroll
      </motion.div>
    </section>
